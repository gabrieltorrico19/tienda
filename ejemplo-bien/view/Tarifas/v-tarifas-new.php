...
<div class='ctn-form'>
	...
	<div class='form-content'>
		...
		<form action='c-tarifas-save.php' method='POST'>
		<div class='x-2'>
			<input type='text' name='zon' placeholder='Zona de entrega' required />
			<div class='label'>Zona</div>
		</div>
		<div class='x-2'>
			<input type='number' step='0.01' min='0' name='pre' placeholder='Precio delivery en Bs' required />
