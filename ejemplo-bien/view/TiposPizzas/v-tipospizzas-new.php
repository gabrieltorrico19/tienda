...
<div class='ctn-form'>
	...
	<div class='form-content'>
		...
		<form action='c-tipospizzas-save.php' method='POST'>
		<div class='x-2'>
			<input type='text' name='nom' placeholder='Nombre del tipo de pizza' required />
		...
		<div class='x-2'>
			<input type='text' name='img' placeholder='Imagen (ej. pizza.png)' />
