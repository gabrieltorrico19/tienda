...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Gestion de Marcas</h2>
        <div class="text-right mb-3">
            <a href="c-marca-new.php" class="btn btn-success">Agregar Marca</a>
                ...
                <?php if (!empty($marcas)) { ?>
                    <?php foreach ($marcas as $marca) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="c-marca-edit.php?cod=<?php echo $marca->cod; ?>" class="btn btn-warning btn-sm">Editar</a>
                                <a href="c-marca-delete.php?cod=<?php echo $marca->cod; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Estas seguro de que quieres eliminar esta marca?')">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr><td colspan="4" class="text-center">No hay marcas registradas.</td></tr>
                <?php } ?>
            </tbody>
        </table>
    </div>
