    ...
    <div class="admin-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo $baseUrl; ?>/control/Categoria/c-categoria-list.php" class="nav-item active">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <div class="page-actions">
                    <a href="<?php echo $baseUrl; ?>/control/Categoria/c-categoria-new.php" class="btn btn-primary">+ Nueva Categoría</a>
                </div>
            </div>
            ...
            <div class="data-card">
                <div class="data-card-header">
                    <div class="data-card-title">Lista de Categorías</div>
                </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="<?php echo $baseUrl; ?>/control/Categoria/c-categoria-edit.php?cod=<?php echo $categoria->cod; ?>" class="btn btn-sm btn-warning">Editar</a>
                                <a href="<?php echo $baseUrl; ?>/control/Categoria/c-categoria-delete.php?cod=<?php echo $categoria->cod; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar esta categoría?')">Eliminar</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
                ...
                <div class="empty-state">
                    ...
                    <a href="<?php echo $baseUrl; ?>/control/Categoria/c-categoria-new.php" class="btn btn-primary mt-4">+ Agregar Primera Categoría</a>
                </div>
                <?php } ?>
            </div>
        </main>
