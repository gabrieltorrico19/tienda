...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Gestion de Categorias</h2>
        <div class="text-right mb-3">
            <a href="c-categoria-new.php" class="btn btn-success">Agregar Categoria</a>
                ...
                <?php if (!empty($categorias)) { ?>
                    <?php foreach ($categorias as $categoria) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="c-categoria-edit.php?cod=<?php echo $categoria->cod; ?>" class="btn btn-warning btn-sm">Editar</a>
                                <a href="c-categoria-delete.php?cod=<?php echo $categoria->cod; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Estas seguro de que quieres eliminar esta categoria?')">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr><td colspan="4" class="text-center">No hay categorias registradas.</td></tr>
                <?php } ?>
            </tbody>
        </table>
    </div>
