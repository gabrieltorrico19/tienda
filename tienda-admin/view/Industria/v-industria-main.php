    ...
    <div class="admin-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo $baseUrl; ?>/control/Industria/c-industria-list.php" class="nav-item active">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <div class="page-actions">
                    <a href="<?php echo $baseUrl; ?>/control/Industria/c-industria-new.php" class="btn btn-primary">+ Nueva Industria</a>
                </div>
            </div>
            ...
            <div class="kpi-grid">
                <div class="kpi-card mint">
                    ...
                    <div class="kpi-value"><?php echo $totalIndustrias; ?></div>
                </div>
            </div>
            
            <div class="data-card">
                <div class="data-card-header">
                    <div class="data-card-title">Lista de Industrias</div>
                </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="<?php echo $baseUrl; ?>/control/Industria/c-industria-edit.php?cod=<?php echo $industria->cod; ?>" class="btn btn-sm btn-warning">Editar</a>
                                <a href="<?php echo $baseUrl; ?>/control/Industria/c-industria-delete.php?cod=<?php echo $industria->cod; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar esta industria?')">Eliminar</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
                ...
                <div class="empty-state">
                    ...
                    <div class="empty-state-text">No hay industrias registradas</div>
                    <a href="<?php echo $baseUrl; ?>/control/Industria/c-industria-new.php" class="btn btn-primary mt-4">+ Agregar Primera Industria</a>
                </div>
                <?php } ?>
            </div>
        </main>
